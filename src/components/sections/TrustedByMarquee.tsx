    ...
    return (
        <section className="relative py-12 border-y border-border bg-surface overflow-hidden">
            <div className="container mx-auto px-4">
                ...
                <LogoCloud
                    logos={clients}
                    className="[&_img]:h-24 [&_img]:md:h-28 [&_img]:opacity-80 [&_img]:hover:opacity-100 [&_img]:transition-opacity [&_img]:duration-300 [&_img]:dark:brightness-100 [&_img]:dark:invert-0"
                />
